...
<body>
    ...
    <br>
		...
		<table>
			<tr>
			<th colspan="3">${pageInfo.eTitle}</th>
			</tr>
			<tr>
				<td style="border-bottom: #111111 solid 1px;
	padding: 5px 5px 25px;">${pageInfo.eReg} &nbsp; 조회수 ${pageInfo.eHit} &nbsp; ${pageInfo.aId}</td>
			</tr>
			<tr>
				<td colspan="3" style="border-bottom: #333333 solid 1px;
					padding: 35px 5px 25px;"><pre>${pageInfo.eContent}</pre></td>
			</tr>
		</table>
		<br><br>
    <div class="modify-button_wrap">
	  ...
	  <form id="infoForm" action="/board/modifyE" method="get">
...
<script>
	...
	$("#delete_btn").on("click", function(e){
		form.attr("action", "/board/deleteE");
